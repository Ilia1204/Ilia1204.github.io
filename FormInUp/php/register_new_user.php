    <?php
        ...
        else 
        {
            ...
            $password = trim($password);
                ...
                /* $insert_sql = "INSERT INTO users (name, surname, email_user, user_id, password)" .
                        "VALUES('{$name}', '{$surname}', '{$surname}', '{$email_user}','{$user_id}','{$password}');";
            ...
            /*if (md5($password) === '1afa148eb41f2e7103f21410bf48346c') { 
               $password = "***********";
             }*/
                ...
                {
                    echo 'Вы успешно зарегистрировались! Подтвердите пожалуйста вашу почту: ' . $email_user . ".";
                }
                else {
